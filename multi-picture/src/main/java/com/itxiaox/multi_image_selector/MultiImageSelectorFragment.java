...
import com.itxiaox.multi_image_selector.adapter.FolderAdapter;
import com.itxiaox.multi_image_selector.adapter.ImageGridAdapter;
import com.itxiaox.multi_image_selector.bean.Folder;
import com.itxiaox.multi_image_selector.bean.Image;
import com.itxiaox.multi_image_selector.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public static final String TAG = "me.itxiaox.multi_image_selector.MultiImageSelectorFragment";
...
//        }
        ...
        PhotoHelper.build().openSysCamera(getActivity(), new ResultListener<File>() {
            @Override
            public void onSuccess(File filePath) {
//                startActivityForResult(cameraIntent, REQUEST_CAMERA);
                mTmpFile = filePath;
                if (mCallback != null) {
                        mCallback.onCameraShot(filePath);
                    }
            }

            @Override
            public void onFail(String error) {
                Toast.makeText(getActivity(), "相机打开失败："+error, Toast.LENGTH_SHORT).show();
            }
        });
    }
